...
class Mortgage_Calculator:
    ...
    def calculate(principal, annual_interest_rate, term_in_years):
        ...
        for month in range(1, term_in_months):
            ...
            holder.monthly_mortgage_payment = Mortgage_Calculator.calculate_monthly_mortgage_payment(principal, annual_interest_rate, holder.mortgage_month)
    ...
    def calculate_monthly_mortgage_payment(annual_interest_rate, principal, mortgage_month):
        return 100
    ...
    def calculate_principal_component(monthly_mortgage_payment, interest_component):
        return monthly_mortgage_payment - interest_component
